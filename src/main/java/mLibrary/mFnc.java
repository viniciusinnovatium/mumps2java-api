...
public final class mFnc extends mParent {
	 ...
	 * <br>position	Optional â€” The position of a character within a character string, counting from 1. The default is 1.
	 ...
	 *            position -> Optional â€” The position of a character within a
	 ...
	 *            case. </br> default - Optional â€” The value to be returned if
	 ...
	 *         valid CachÃ© ObjectScript expression. <br/>
	 ...
	 *         an integer variable, or any valid CachÃ© ObjectScript expression
	 *         that evaluates to a positive integer. <br/>
	 *         decimal -> Optional â€” The position at which to place the decimal
	 *         point within the width. It can be a positive integer value, the
	 *         name of an integer variable, or any valid CachÃ© ObjectScript
