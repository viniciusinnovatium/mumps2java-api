...
public class CacheManagerDataPersistenceTest {
	...
	public void testJDBCDataPersistence() {
		...
		cacheManager.put(new Node("www001", path, 98));
	...
	public void testJDBCDataUpdating() {
		String path = "vinicius";
		cacheManager.put(new Node("www001", path, "xxx"));
		assertEquals("Fail on search key/value pair", "xxx", cacheManager.get(path));
		
		cacheManager.put(new Node("www001", path, "aaa"));
	...
	public void testJDBCDataDeleting() {
		String path = "maria";
		cacheManager.put(new Node("www001", path, "mae de deus"));
	...
	public void testJDBCDataSearching() {
		cacheManager.put(new Node("www001", "qwer1", "mae de deus"));
		cacheManager.put(new Node("www001", "qwer2", "mae de deus"));
		cacheManager.put(new Node("www001", "qwer3", "mae de deus"));
	...
	public void testJDBCDataOrdering() {
		cacheManager.put(new Node("www001", "maria10", "mae de deus"));
		cacheManager.put(new Node("www001", "maria3", "mae de deus"));
		cacheManager.put(new Node("www001", "maria2", "mae de deus"));
		cacheManager.put(new Node("www001", "maria1", "mae de deus"));
	...
	public void testJDBCKillData() {
		cacheManager.put(new Node("www001", "a/w/3/3/4/5", "mae de deus"));
		cacheManager.put(new Node("www001", "a/w/3/3", "mae de deus"));
		cacheManager.put(new Node("www001", "a/w/3", "mae de deus"));
		cacheManager.put(new Node("www001", "a/w/2/1", "mae de deus"));
		cacheManager.put(new Node("www001", "a/w/2", "mae de deus"));
